...
class OrdersProvider {
  ...
  //     }
  //
  //     final List<dynamic> data = json.decode(res.body); // Lista de pedidos
  //     List<Order> order = data.map((item) => Order.fromJson(item)).toList();
  //
  //     print("Categorías obtenidas en frontend: $order");
  //
  //     return order;
  //   } catch (e) {
  //     print('Error: $e');
  ...
  //     final res = await http.get(url, headers: headers);
  //
  //     print('Respuesta HTTP status: ${res.statusCode}');
